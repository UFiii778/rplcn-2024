...
export default function StudentListPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 px-4 py-12 sm:px-8">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header className="text-center mb-16 space-y-3">
          <span className="px-4 py-1.5 rounded-full text-xs font-semibold tracking-wider uppercase bg-indigo-500/10 text-indigo-400 border border-indigo-500/20">
            Class Directory
          </span>
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-200 to-indigo-300">
            Meet Our Class
          </h1>
        ...
        <section className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {studentsData.map((student) => (
            <Link
              ...
              className="group relative bg-slate-900/40 hover:bg-slate-800/60 border border-slate-800 hover:border-indigo-500/40 rounded-2xl p-4 flex flex-col items-center text-center backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-500/5"
            >
              <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-xl overflow-hidden mb-3 border border-slate-700/50 group-hover:border-indigo-400 transition-colors">
