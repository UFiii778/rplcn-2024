...
const Contact = ({ student }) => {
  return (
    <section id="contact" className="w-full max-w-4xl mx-auto px-6 py-6">
      <div className="w-full min-h-[220px] bg-stone-700/30 border border-stone-600/40 rounded-3xl p-8 flex flex-col items-center justify-center text-center shadow-lg">
